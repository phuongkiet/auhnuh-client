                        ...
                        season.episodes.map((episode) => (
                            <div key={episode.id}
                                ...
                                <div className="flex items-center pr-4">
                                    <button
                                        className="px-2 pt-1 bg-white rounded-full text-black transform group-hover:scale-110 transition-transform duration-300" onClick={() => watchMovie(episode.id)}>
