    ...
    <section className="py-6 px-12">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex space-x-2">
          <button className="bg-zinc-800 hover:bg-zinc-700 rounded-full w-8 h-8 flex items-center justify-center transition-colors duration-300">
            ...
            <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black to-transparent p-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              ...
              <div className="flex items-center mt-2 space-x-2">
                <button
                  ...
                  onClick={() => navigate(`/movie/detail/${anime.movieId}`)}
                >
                  <span className="material-symbols-outlined text-sm">
                    play_arrow
                  </span>
                </button>
                <button className="bg-zinc-800/80 rounded-full w-8 h-8 flex items-center justify-center hover:bg-zinc-700 transition-colors duration-300">
